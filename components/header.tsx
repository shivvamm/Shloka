  ...
  return (
    <div className="container px-2 relative mx-auto max-w-4xl text-center mt-20 pt-20 pb-10 bg-gradient-to-r">
      ...
      <div className="py-10">
        ...
        <p className="my-2">
          Powered by <a href="http://expressjs.com/">Express.js</a> ,
          <a href="https://redis.io/">Redis</a> with{' '} , <a href="https://jestjs.io/">Jest</a> and{' '} <a href="https://www.docker.com/">Docker</a>
        </p>
      </div>
      ...
      <a
        ...
        target="_blank"
        href="https://www.buymeacoffee.com/shivvamm">
